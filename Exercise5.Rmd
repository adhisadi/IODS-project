...
p <- ggpairs(human_, mapping = aes(), lower = list(combo=wrap("facethist", bins=20)))+theme_bw()
p
...
#The labels produced are of different sizes for the two sets deeppink2 is slightly bigger than gray40 fonts.
...
# With habillage = "quali", the color of ind values changed. Different values present in same column of the data have same color.
